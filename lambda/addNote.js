...
function handler(event, context, callback) {
  ...
  var options = {
    ...
    url: "https://www.humanity.com/api/v2/timeclocks/savenote?access_token=" + token,
    headers: {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_2_request__["default"])(options, function (error, response, body) {
    ...
    if (event.queryStringParameters.id != 'none') {
      var x = Object(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify__["default"])(event.queryStringParameters.id, function (key, value) {
