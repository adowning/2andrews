...
exports.handler = function (event, context, callback) {
  ...
  var assigned_asset = Object(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify__["default"])(aa);
  var au = JSON.parse(event.queryStringParameters.assigned_user);
  var assigned_user = Object(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify__["default"])(au);
  ...
  snipeit.post("http://47.219.112.177:83/api/v1/hardware/" + assigned_asset + "/checkout?assigned_user=" + assigned_user + "&assigned_asset=" + assigned_asset + "&checkout_to_type=user").then(function (response) {
    ...
    var x = Object(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify__["default"])(response.data, function (key, value) {
